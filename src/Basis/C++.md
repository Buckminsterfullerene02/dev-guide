...
There already exists a very strong [C++](https://docs.ue4ss.com/cpp-api.html) and [Lua](https://docs.ue4ss.com/lua-api.html) API via a tool called UE4SS that works for any UE game, which you should be aware of, whether or not you decide to go down this route natively. 

Additionally, there is a UE plugin called [LuaMachine](https://github.com/rdeioris/LuaMachine) that provides a more native approach to Lua scripting.
